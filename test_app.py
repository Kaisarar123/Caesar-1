...
questions = [
    {
        ...
        "options": [
            "Туынды қатенің қисығы",
            "Гаусс қатенің қисығы",
            "Бөлшектік қатенің қисығы",
            "Салыстырмалы қатенің қисығы",
            "Абсолют қатенің қисығы",
            "Джоуль қатенің қисығы",
            "Ньютон қатенің қисығы",
            "Резерфорд қатенің қисығы"
        ],
    ...
    },
    {
        ...
        "options": [
            "тұрақты температура",
            "Авогадро температурасы",
            "ғарыштық температура",
            "өзгерісті температура",
            "энергетикалық температура",
            "Жер температурасы",
    ...
    },
    {
        ...
        "options": [
            "модельденген газ",
            "өзара әрекет ескерілмейтін газ",
            "нақты және идеал газ",
            "шынайы газ",
            "нақты газ",
            "идеал газ"
        ],
    ...
    },
    {
        ...
        "options": [
            r"I = \sum_{i=1}^{n} m_i r_i",
            r"L = \sum_{i=1}^{n} m_i r_i^2",
            r"I = \sum_{i=1}^{n} m_i r_i^2",
            r"I = \int r^2 dm",
            r"I = \sum m_i v_i^2"
        ],
    ...
    },
    {
        ...
        "options": [
            r"\vec{\omega} = \frac{d\varphi}{dt}",
            r"\omega = \frac{d\varphi}{dt}",
            r"\omega = \frac{d\varphi}{dt}",
            r"\omega = \frac{d^2 \varphi}{dt}",
            r"\vec{\omega} = \frac{d\varphi}{dt}"
        ],
    ...
    },
    {
        ...
        "correct": ["айналып тұрған санақ жүйесінде жылдамдықпен қозғалыстағы денеге әсер ететін инерция күші"]
    },
    {
    ...
    },
    {
        ...
        "correct": ["Q = \\frac{\\pi R^4 \\Delta p t}{8 \\eta l}"]
    },
    {
    ...
    },
    {
        ...
        "correct": ["\\frac{d^2 s}{dt^2} + \\omega_0^2 s = 0"]
    },
    {
    ...
    },
    {
        ...
        "correct": ["Ньютонның бірінші заңы"]
    },
    {
        "question": "Инерция күштерін",
        "options": [
            "денелердің өзара әрекеттесуі тудырады",
            "санақ жүйесінің бірқалыпты қозғалысы тудырады",
            "санақ жүйесінің түзу сызықты қозғалысы тудырады",
            "санақ жүйесінің үдемелі қозғалысы тудырады",
            "денелердің үдемелі қозғалысы тудырады"
        ],
        "correct": ["денелердің үдемелі қозғалысы тудырады"]
    },
    {
    ...
    },
    {
        ...
        "options": [
            "тұйықталған жүйенің импульсі сақталады",
            "импульс уақыт бойынша өзгеріссіз қалады",
            "тұйықталған жүйенің импульс моменті сақталады",
            "тұйықталмаған жүйенің импульс моменті сақталады",
            "импульс моменті уақыт бойынша өзгереді"
        ],
        "correct": ["импульс уақыт бойынша өзгеріссіз қалады"]
    },
    {
        ...
        "correct": ["консервативтік"]
    },
    {
        "question": "Шеңбер бойымен қозғалыс кезінде",
        "options": [
            "нормал үдеу траекторияға жанама бағытталған",
            "толық үдеу траекторияға жанама бағытталған",
            "тангенциал үдеу траекторияға жанама бағытталған",
            "тангенциал үдеу траекторияға нормаль бағытталған",
            "тангенциал үдеу шеңбер центріне бағытталған"
        ],
        "correct": ["тангенциал үдеу траекторияға жанама бағытталған"]
    },
    {
        "question": "Бірқалыпты түзу сызықты қозғалыс",
        "options": [
            "бірқалыпты үдемелі қозғалыс",
            "әртүрлі уақыт аралықтарында бірдей жол жүретін қозғалыс",
            "бірдей уақыт аралықтарында әртүрлі жол жүретін қозғалыс",
            "бірдей уақыт аралықтарында бірдей жол жүретін қозғалыс",
            "тұрақты үдеумен өтетін қозғалыс"
        ],
        "correct": ["бірдей уақыт аралықтарында бірдей жол жүретін қозғалыс"]
    },
    {
