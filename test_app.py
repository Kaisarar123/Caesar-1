...
questions = [
    ...
    },
    {
        ...
        "latex": r"G_+ = \frac{1}{3} n \vartheta g_0 + \frac{1}{6} n \vartheta \lambda \frac{dg}{dx}",
            ...
            r"G₊ = 1/7 nϑg₀ + 1/6 nϑλ dg/dx",
            r"G₊ = 1/6 nϑg₀ − 1/6 nϑλ dg/dx",
            r"G₊ = 1/3 nϑg₀ + 1/6 nϑλ dg/dx",
            r"G₊ = 1/5 nϑg₀ × 1/6 nϑλ dg/dx",
            r"G₊ = 1/4 nϑg₀ + 1/6 nϑθλ dg/dx",
            r"G₊ = 1/2 nϑg₀ − 1/6 nϑθλ dg/dx",
...
},
{
...
},
    {
        ...
        "latex": "F = G \\frac{m_1 m_2}{r^2}",
            ...
            r"F = G \\frac{m_1 m_2}{r}",
            r"F = g \\frac{m_1 m_2}{r^2}",
            r"F = \\frac{m_1 m_2}{r^2}",
            r"F = G \\frac{m}{r^2}",
            r"F = G \\frac{m_1 m_2}{r^2}",
    ...
    },
    {
        ...
        "latex": "\\varphi = \\frac{GM}{R}",
            ...
            r"\\varphi = \\frac{F}{m}",
            r"\\varphi = \\frac{GM}{R}",
            r"\\varphi = \\frac{E_{тол}}{m}",
            r"\\varphi = \\frac{\\vec{E}_n}{m}",
            r"\\varphi = \\frac{E_n}{m}",
    ...
    },
    {
        ...
        "latex": "Q = \\frac{\\pi R^4 \\Delta p t}{8 \\eta l}",
            ...
            r"Q = \\frac{\\pi R^4 \\Delta p t}{8 \\eta l}",
            r"\\frac{\\pi R^4 pt}{8 \\eta l}",
            r"Q = \\frac{\\pi R^2 \\Delta p t}{8 \\eta l}",
            r"Q = \\frac{\\pi R^4 \\Delta p t}{8 \\eta}",
            r"Q = \\frac{\\pi R^4 (p_2 - p_1) t}{8 \\eta l}",
    ...
    },
    {
        ...
        "latex": "\\frac{d^2 s}{dt^2} + \\omega_0^2 s = 0",
            ...
            r"\\frac{d^2 s}{dt^2} + \\omega_0^3 s = 0",
            r"\\frac{ds}{dt} + \\omega_0 s = 0",
            r"\\frac{d^2 s}{dt^2} + \\omega_0^2 s = 0",
            r"\\frac{d^2 s}{dt^2} + \\omega_0^5 s = 0",
