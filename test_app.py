...
},
{
  ...
  },
  {
    ...
    {
        "question": "Жерден горизонтқа бұрыш жасай лақтырылған дене траекторияның жоғарғы нүктесіндегі үдеуі",
        "options": [
            "траектория центріне қарай бағытталған",
            "төмен қарай бағытталған",
            "нөлге тең",
            "траекторияға жанама бағытталған",
            "жоғары қарай бағытталған"
        ],
        "correct": ["траекторияға жанама бағытталған"]
    },
    {
        "question": "Күш",
        "options": [
            "қозғалыс мөлшерін сипаттайтын векторлық шама",
            "дененің инерттілігін сипаттайтын скалярлық шама",
            "қозғалыс мөлшерін сипаттайтын скалярлық шама",
            "әсердің мөлшерін сипаттайтын векторлық шама",
            "әсердің мөлшерін сипаттайтын скалярлық шама"
        ],
        "correct": ["әсердің мөлшерін сипаттайтын векторлық шама"]
    },
    {
        "question": "Бірқалыпсыз қозғалыстың орташа үдеу векторының дұрыс өрнегі",
        "latex": r"\langle \vec{a} \rangle = \frac{d\vec{v}}{dt}",
        "options": [
            r"\frac{d\vec{v}}{dt}",
            r"\frac{d\vec{s}}{dt}",
            r"\langle \vec{v} \rangle = \frac{d\vec{v}}{dt}",
            r"\frac{d\vec{r}}{dt}",
            r"\langle \vec{a} \rangle = \frac{d\vec{v}}{dt}"
        ],
        "correct": [r"\langle \vec{a} \rangle = \frac{d\vec{v}}{dt}"]
    },
    {
        "question": "Айналмалы қозғалыстағы қатты дененің кез келген нүктесі айналу өсінен R қашықтықта болса, нүктенің тангенциал үдеуінің өрнегі",
        "options": [
            r"w_\tau = \omega R",
            r"w_n = \omega R",
            r"w_n = \omega^2 R",
        ...
        "correct": [r"w_\tau = \omega^2 R"]
    },
    {
        "question": "Күш импульсі",
        "options": [
            r"(\vec{r}, \vec{F}) – векторлар",
            r"(\vec{F}, d\vec{r}) – скалярлар",
            r"\int_{t_1}^{t_2} F dt – векторлар",
            r"(\vec{r}, d\vec{r}) – векторлар",
            r"(\vec{F}, d\vec{r}) – скалярлар"
        ],
        "correct": [r"(\vec{r}, \vec{F}) – векторлар"]
    },
    {
        "question": "Импульстің сақталу заңы",
        "options": [
            "тұйықталмаған жүйесінің импульсы тұрақты болып қалады",
            "тұйықталған жүйесінің импульсы уақыт бойынша өзгереді",
            "тұйықталған жүйесінің импульсы кемиді",
            "тұйықталған жүйесінің импульсы тұрақты болып қалады",
            "тұйықталған жүйесінің импульсы артады"
        ],
        "correct": ["тұйықталған жүйесінің импульсы тұрақты болып қалады"]
    },
    {
        "question": "Жүйенің тепе-теңдік орнықты күйі шарты",
        "options": [
            r"E_{пот} = const",
            r"E_{кин} = E_{пот.min}",
            r"E_{пот} = E_{пот.max}",
        ...
        "correct": [r"E_{пот} = const"]
    },
    {
        "question": "Сыртқы күштердің тең әсерлісі нөлге тең болса, тұйықталмаған жүйе импульсы",
        "options": [
            "артады",
            "өзгереді",
            "кемиді",
        ...
        "correct": ["тұрақты болып қалады"]
    },
    {
        "question": "Тұйық жүйе үшін импульс моментінің сақталу заңы",
        "options": [
            r"\vec{p} = const",
            r"\vec{\bar{p}} = const",
            r"\vec{L} = const",
    ...
    },
     {
        ...
        "answer": "траекторияға жанама бағытталған"
    },
    {
        "question": "Күш",
        "options": [
        ...
        "answer": "әсердің мөлшерін сипаттайтын векторлық шама"
    },
    {
        "question": "Бірқалыпсыз қозғалыстың орташа үдеу векторының дұрыс өрнегі",
        "latex": r"\langle \vec{a} \rangle = \frac{d\vec{v}}{dt}",
        "options": [
            r"\langle \vec{v} \rangle = \frac{d\vec{v}}{dt}",
            r"\langle \vec{a} \rangle = \frac{d\vec{s}}{dt}",
            r"\langle \vec{a} \rangle = \frac{d\vec{v}}{dt}",
            r"\langle \vec{a} \rangle = \frac{d\vec{r}}{dt}",
            r"\langle \vec{a} \rangle = \frac{d\vec{v}}{dt}"
        ],
        "answer": r"\langle \vec{a} \rangle = \frac{d\vec{v}}{dt}"
    },
    {
        "question": "Айналмалы қозғалыстағы қатты дененің кез келген нүктесі айналу өсінен R қашықтықта болса, нүктенің тангенциал үдеуінің өрнегі",
        "latex": r"w_{\tau} = \omega^2 R",
        "options": [
            r"w_{\tau} = \omega R",
            r"w_n = \omega R",
            r"w_n = \omega^2 R",
    ...
    },
    {
        ...
        "options": [
            r"(\vec{r}, \vec{F}) – векторлар",
            r"(\vec{F}, d\vec{r}) – скалярлар",
            r"\int_{t_1}^{t_2} \vec{F} dt – векторлар",
            r"(\vec{r}, d\vec{r}) – векторлар",
            r"(\vec{F}, d\vec{r}) – скалярлар"
        ],
        "answer": r"(\vec{r}, \vec{F}) – векторлар"
    },
    {
        "question": "Импульстің сақталу заңы",
        "options": [
        ...
        "answer": "тұйықталған жүйесінің импульсы тұрақты болып қалады"
    },
    {
        "question": "Жүйенің тепе-теңдік орнықты күйі шарты",
        "options": [
        ...
        "answer": r"E_{пот} = const"
    },
    {
        "question": "Сыртқы күштердің тең әсерлісі нөлге тең болса, тұйықталмаған жүйе импульсы",
        "options": [
            "артады", "өзгереді", "кемиді", "тұрақты болып қалады", "нөлге тең"
        ],
        "answer": "тұрақты болып қалады"
    },
    {
        "question": "Тұйық жүйе үшін импульс моментінің сақталу заңы",
        "options": [
            r"\vec{p} = const", r"\vec{p} = const", r"\vec{L} = const",
            r"\vec{L} = 0", r"\vec{M} = const"
        ],
        "answer": r"\vec{L} = const"
    }
