...
},
{
    ...
    {
        "question": "x₁ = 3sinπt және x₂ = 4sin(πt + π/2) гармоникалық тербелістер қосылады. Қорытқы тербелістің амплитудасы",
        "options": [
            "7 м",
            "6 м",
            "3 м",
    ...
    {
        "question": "Маятниктің гармониялық тербеліс теңдеуі x = A \\sin(\\alpha t), \\omega = \\frac{\\pi}{6}. Маятник амплитудасын жартысына ауытқуы үшін қажет уақыт",
        "options": [
            "1 с",
            "1,5 с",
            "0,5 с",
